...
$(document).ready(function () {
  var selected = $("#dropdown-flag .selected-language").text().replace(/\s/g, '');
  $(".dropdown-language .dropdown-item").each(function (index) {
...
module.exports = __webpack_require__(/*! E:\Project\laravel\E-commerce\resources\js\core\app.js */"./resources/js/core/app.js");
