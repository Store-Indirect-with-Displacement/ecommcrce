...
/***/ "./resources/js/core/app-menu.min.js":
/*!*******************************************!*\
  !*** ./resources/js/core/app-menu.min.js ***!
  \*******************************************/
...
!function (o, s, r) {
  ...
  var e = .01 * o.innerHeight;
  s.documentElement.style.setProperty("--vh", e + "px"), r.app = r.app || {};
  var l = r("body"),
      d = r(o),
      t = r('div[data-menu="menu-wrapper"]').html(),
  ...
  r.app.menu = {
    ...
    manualScroller: {
      ...
      update: function update() {
        if (this.obj) {
          if (!0 === r(".main-menu").data("scroll-to-active")) {
            var e, n, a;
            if (e = s.querySelector(".main-menu-content li.active"), l.hasClass("menu-collapsed")) r(".main-menu-content li.sidebar-group-active").length && (e = s.querySelector(".main-menu-content li.sidebar-group-active"));else if (n = s.querySelector(".main-menu-content"), e && (a = e.getBoundingClientRect().top + n.scrollTop), a > parseInt(2 * n.clientHeight / 3)) var i = a - n.scrollTop - parseInt(n.clientHeight / 2);
            setTimeout(function () {
      ...
      updateHeight: function updateHeight() {
        "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") && "vertical-overlay-menu" != l.data("menu") || !r(".main-menu").hasClass("menu-fixed") || (r(".main-menu-content").css("height", r(o).height() - r(".header-navbar").height() - r(".main-menu-header").outerHeight() - r(".main-menu-footer").outerHeight()), this.update());
      }
    },
    ...
    drillDownMenu: function drillDownMenu(e) {
    ...
    change: function change(e) {
      ...
      if (n) switch (n.name) {
        case "xl":
          "vertical-overlay-menu" === s ? this.hide() : "collapsed" === e ? this.collapse(e) : this.expand();
          break;
      ...
      "vertical-menu" !== s && "vertical-menu-modern" !== s || this.toOverlayMenu(n.name, s), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), r(".menu-toggle").removeClass("is-active")), "horizontal-menu" != s && this.drillDownMenu(n.name), "xl" == n.name && (r('body[data-open="hover"] .header-navbar .dropdown').on("mouseenter", function () {
      ...
      }), "horizontal-menu" == s && (r("li.dropdown-submenu").on("mouseenter", function () {
        ...
        if (e) {
          ...
          0 <= i + s - (o.innerWidth - 16) && r(this).addClass("openLeft");
        }
      }), r(".theme-layouts").find(".semi-dark").hide(), r("#customizer-navbar-colors").hide()), "vertical-menu" !== s && "vertical-overlay-menu" !== s || (jQuery.expr[":"].Contains = function (e, n, a) {
        return 0 <= (e.textContent || e.innerText || "").toUpperCase().indexOf(a[3].toUpperCase());
      }, a = r("#main-menu-navigation"), i = r(".menu-search"), r(i).change(function () {
        var e = r(this).val();
    ...
    expand: function expand() {
      !1 === this.expanded && ("vertical-menu-modern" == l.data("menu") && r(".modern-nav-toggle").find(".toggle-icon").removeClass("feather icon-circle").addClass("feather icon-disc"), this.transit(function () {
    ...
    collapse: function collapse(e) {
      !1 === this.collapsed && ("vertical-menu-modern" == l.data("menu") && r(".modern-nav-toggle").find(".toggle-icon").removeClass("feather icon-disc").addClass("feather icon-circle"), this.transit(function () {
        ...
        "horizontal-menu" == l.data("menu") && l.hasClass("vertical-overlay-menu") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable(), "vertical-menu" != l.data("menu") && "vertical-menu-modern" != l.data("menu") || !r(".main-menu").hasClass("menu-fixed") || r(".main-menu-content").css("height", r(o).height() - r(".header-navbar").height()), "vertical-menu-modern" == l.data("menu") && r(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable();
      }));
    },
    ...
    changeMenu: function changeMenu(e) {
      r('div[data-menu="menu-wrapper"]').html(""), r('div[data-menu="menu-wrapper"]').html(t);
      var n = r('div[data-menu="menu-wrapper"]'),
          ...
          s = r('li[data-menu="dropdown-submenu"]');
      "xl" === e ? (l.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(l.data("menu")), r("nav.header-navbar").removeClass("fixed-top"), n.removeClass().addClass(m), this.drillDownMenu(e), r("a.dropdown-item.nav-has-children").on("click", function () {
      ...
      }), r(".main-menu-content").find("li.active").parents("li").addClass("sidebar-group-active"), r(".main-menu-content").find("li.active").closest("li.nav-item").addClass("open"));
    },
      ...
      r(".navigation-main").on("mouseenter.app.menu", "li", function () {
        ...
        if (r(".hover", ".navigation-main").removeClass("hover"), l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu")) {
          ...
          var n,
              a,
              i,
              s = e.find("span.menu-title").clone();

          if (e.hasClass("has-sub") || (n = e.find("span.menu-title").text(), a = e.children("a").attr("href"), "" !== n && ((s = r("<a>")).attr("href", a), s.attr("title", n), s.text(n), s.addClass("menu-title"))), i = e.css("border-top") ? e.position().top + parseInt(e.css("border-top"), 10) : e.position().top, "vertical-compact-menu" !== l.data("menu") && s.appendTo(".main-menu-content").css({
            position: "fixed",
            top: i
        ...
        var n = r(this);
        n.is(".disabled") ? e.preventDefault() : l.hasClass("menu-collapsed") && "vertical-menu-modern" != l.data("menu") ? e.preventDefault() : n.has("ul").length ? n.is(".open") ? n.trigger("close.app.menu") : n.trigger("open.app.menu") : n.is(".active") || (n.siblings(".active").trigger("deactive.app.menu"), n.trigger("active.app.menu")), e.stopPropagation();
        ...
        var n = r(this);
        if (n.is(".disabled")) e.preventDefault();else if (n.has("ul")) {
          if (n.is(".open")) n.removeClass("open"), t.collapse(n);else {
            if (n.addClass("open"), t.expand(n), r(".main-menu").hasClass("menu-collapsible")) return !1;
            n.siblings(".open").find("li.open").trigger("close.app.menu"), n.siblings(".open").trigger("close.app.menu"), e.stopPropagation();
          }
    ...
    adjustSubmenu: function adjustSubmenu(e) {
      var n,
          a,
          i,
          s,
          ...
          l = o.clone(!0);
      r(".main-menu-header").height(), n = e.position().top, i = d.height() - r(".header-navbar").height(), t = 0, o.height(), 0 < parseInt(e.css("border-top"), 10) && (t = parseInt(e.css("border-top"), 10)), s = i - n - e.height() - 30, r(".main-menu").hasClass("menu-dark"), a = n + e.height() + t, l.addClass("menu-popout").appendTo(".main-menu-content").css({
        top: a,
        position: "fixed",
        "max-height": s
      });
...
/***/ 1:
/*!*************************************************!*\
  !*** multi ./resources/js/core/app-menu.min.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\Project\laravel\E-commerce\resources\js\core\app-menu.min.js */"./resources/js/core/app-menu.min.js");
