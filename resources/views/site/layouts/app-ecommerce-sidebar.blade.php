        ...
        <div class="card-body">
            <div class="multi-range-price">
                ...
                <ul class="list-unstyled price-range" id="price-range">
                    ...
                    <li>
                        <span class="vs-radio-con vs-radio-primary py-25">
                            <input type="radio" name="price-range" value="500">
                            <span class="vs-radio">
                                <span class="vs-radio--border"></span>
                                <span class="vs-radio--circle"></span>
                            </span>
                    ...
                    <li>
                        <span class="vs-radio-con vs-radio-primary py-25">
                            <input type="radio" name="price-range" value="501">
                            <span class="vs-radio">
                                <span class="vs-radio--border"></span>
                                <span class="vs-radio--circle"></span>
                            </span>
            ...
            <div id="product-categories">
                ...
                <ul class="list-unstyled categories-list" id="categories">
                    <?php foreach ($catagoires as $cat): ?>
                        <li>
                            <span class="vs-radio-con vs-radio-primary py-25">
                                ...
                                <span class="ml-50"><?= $cat->name ?></span>
                            </span>
                        </li>
                    <?php endforeach; ?>
                </ul>
