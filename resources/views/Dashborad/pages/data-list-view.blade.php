                    ...
                    <div class="data-fields px-2 mt-1">
                        <div class="row">
                            <div class="col-sm-12 data-field-col">
                                ...
                                <input type="text" class="form-control" name="en_name" id="data-name">
                            </div>
                                <div class="col-sm-12 data-field-col">
                                <label for="data-name">Arabic Name</label>
                                <input type="text" class="form-control" name="ar_name" id="data-name">
                            </div>
                            <div class="col-sm-12 data-field-col">
