        ...
        <div class="add-new-data">
                    ...
                    <div class="row">
                        <?php foreach (LaravelLocalization::getSupportedLocales() as $local => $prop): ?>
                            <div class="col-sm-12 data-field-col">
                                ...
                                <?php endif; ?>
                                <input type="text" name="name_<?= $local ?>" class="form-control" id="data-name">
                            </div>
                        <?php endforeach; ?>
                        <div  class="col-sm-12 data-field-col">
                        ...
                        <div class="col-sm-12 data-field-col">
                            ...
                            <select class="form-control" id="data-subcategory">
                        ...
                        <div class="col-sm-12 data-field-col">
                            ...
                            <select class="form-control" id="data-subsubcategory">
                                <option selected>select subsubCategory</option>
            ...
            <div class="add-data-footer d-flex justify-content-around px-3 mt-2">
                <div class="add-data-btn">
                    <button id="saveproduct"class="btn btn-primary">{{__('main.Save')}}</button>
                </div>
