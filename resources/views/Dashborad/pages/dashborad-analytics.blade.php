...
<?php elseif( LaravelLocalization::getCurrentLocaleDirection() === 'rtl'):?>
    <link rel="stylesheet" href="{{ asset('css-rtl/pages/dashboard-analytics.css') }}">
<link rel="stylesheet" href="{{ asset('css-rtl/pages/card-analytics.css') }}">
<link rel="stylesheet" href="{{ asset('css-rtl/plugins/tour/tour.css') }}">
<?php endif;?>
@endsection
@section('content')
                ...
                <div class="card-content">
                    <div class="card-body text-center">
                        ...
                        <div class="text-center">
                            <h1 class="mb-2 text-white">{{__('main.Congratulations')}} <?= auth()->user()->name ?>,</h1>
                            <p class="m-auto w-75">{{__('main.done')}} <strong>57.6%</strong> {{__('main.badge')}}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <p class="mb-0">{{__('main.Subscribers')}}</p>
                </div>
                <div class="card-content">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="card">
                <div class="card-header d-flex flex-column align-items-start pb-0">
                    ...
                    <p class="mb-0">{{__('main.Orders Received')}}</p>
                </div>
                <div class="card-content">
                        ...
                        <div class="row pb-50">
                            <div class="col-lg-6 col-12 d-flex justify-content-between flex-column order-lg-1 order-2 mt-lg-0 mt-2">
                                <div>
                                    ...
                                    <p class="text-bold-500 mb-75">{{__('main.Avg Sessions')}}</p>
                                    <h5 class="font-medium-2">
                                        <span class="text-success">+5.2% </span>
                                        <span>{{__('main.vs last')}} 7 {{__('main.days')}}</span>
                                    </h5>
                                </div>
