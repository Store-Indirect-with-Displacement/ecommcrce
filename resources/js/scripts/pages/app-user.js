...
$(document).ready(function () {
    ...
    var customIconsHTML = function (params) {
        var useredit = window.Laravel.UserEdit;
        var id = params.data.id;
        var useredit = useredit.replace(':id', id);
        var usersIcons = document.createElement("span");
        var editIconHTML = "<a href='" + useredit + "'><i class='users-edit-icon feather icon-edit-1 mr-50'></i></a>"
    ...
    if (document.getElementById("myGrid")) {
        ...
        agGrid
                .simpleHttpRequest({
                    url: window.Laravel.getUserData
                })
                .then(function (data) {
